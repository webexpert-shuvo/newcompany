...
<div class="page-wrapper">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <br>
                        <a href="" class="btn  btn-sm btn-success add_procate_btn">Add New Category</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="procatetabel" class="table mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
    ...
    <div id="procat_add_modal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="procat_add_form" method="POST">
                        @csrf
    ...
    <div id="procat_edit_modal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4>Edit Category</h4>
                ...
                <div class="modal-body">
                    <form action="" id="procat_edit_form" method="POST">
                        @csrf
                        <div class="form-group">
                            <input name="name" type="text" placeholder="Category Name" class="form-control">
                        </div>
