                        ...
                        <div class="login-right-wrap">
                            ...
                            <form action="{{ route('login') }}" method="POST" >
                                ...
                                <div class="form-group">
                                    <input name="login_data" class="form-control" type="text" placeholder="Email">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="text-center dont-have">Don’t have an account? <a href="{{ route('show.registerpage') }}">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
